...
CELL_BASE = np.array([
    ...
    [0.0000, 0.0000, 6.5000]   # c (ভিন্ন মান)
])
...
# =====================================================================
# ৩. লুপ চালিয়ে Tetragonal YZ Shear Strain অ্যাপ্লাই ও QE রান করা
# =====================================================================
for delta in strains:
    print(f"Running simulation for Tetragonal Shear strain (C44) delta = {delta}...")
    
    # টেট্রাগোনাল C44 এর জন্য সঠিক Shear Strain Matrix (yz plane shear)
    ...
    # QE ইনপুট টেক্সট জেনারেট করা (আপনার সিস্টেম অনুযায়ী &SYSTEM ব্লক মডিফাই করতে পারেন)
...
"""
    ...
    in_filename = f"scf_tetra_c44_{delta}.in"
    out_filename = f"scf_tetra_c44_{delta}.out"
...
# টেট্রাগোনাল YZ Shear এর ক্ষেত্রে সূত্র: C44 = (2 * A / V0) * ry_to_gpa
C44 = (2 * A / V0) * ry_to_gpa

print("\n================ RESULT ================")
print(f"Calculated Tetragonal C44 Elastic Constant: {C44:.2f} GPa")
print("========================================")

# =====================================================================
# ৫. গ্রাফ প্লট এবং ইমেজ ফাইল হিসেবে সেভ করা
# =====================================================================
plt.plot(strains, delta_E, 'bo', label='DFT Data (YZ Shear)')
...
plt.title(f'Tetragonal $C_{{44}}$ Fit ($C_{{44}}$ = {C44:.2f} GPa)')
plt.legend()
plt.grid(True)
plt.savefig('Tetragonal_C44_fit_plot.png')
print("Graph saved as 'Tetragonal_C44_fit_plot.png'")
plt.show()
